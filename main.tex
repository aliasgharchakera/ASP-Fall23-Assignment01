...
\begin{questions}
        ...
        \begin{solution}
            ...
            \begin{align*}
                \sigma_Y^2 & = \sum_{y \in S_Y} (y - \mu_Y)^2 P(Y = y)                                                                                                                         \\
                           ...
                           & = \frac{1}{8} \left((-2 (-3)^2 + 3 - \mu_Y)^2 + (-2 (-2)^2 + 3 - \mu_Y)^2 + \dots + (-2 (3)^2 + 3 - \mu_Y)^2 + (-2 (4)^2 + 3 - \mu_Y)^2\right)                    \\
                           & = \frac{1}{8} \left((-2 (9) + 3 + \frac{25}{4})^2 + (-2 (4) + 3 + \frac{25}{4})^2 + \dots + (-2 (9) + 3 + \frac{25}{4})^2 + (-2 (16) + 3 + \frac{25}{4})^2\right) \\
                           & = \frac{1}{8} \left((-18 + 3 + \frac{25}{4})^2 + (-8 + 3 + \frac{25}{4})^2 + \dots + (-18 + 3 + \frac{25}{4})^2 + (-32 + 3 + \frac{25}{4})^2\right)
            \end{align*}
        \end{solution}
        ...
        \begin{solution}
            ...
            \begin{align*}
                \mu_Z & = \sum_{z \in S_Z} z P(Z = z)                                                                                                                                                                                                                                                 \\
                      ...
                      & = \frac{1}{8} \left(\cos \left(\frac{-3 \pi}{8}\right) + \cos \left(\frac{-\pi}{4}\right) + \cos \left(\frac{-\pi}{8}\right) + \cos \left(\frac{\pi}{8}\right) + \cos \left(\frac{\pi}{4}\right) + \cos \left(\frac{3 \pi}{8}\right) + \cos \left(\frac{\pi}{2}\right)\right) \\
        ...
        \begin{solution}
            ...
            \begin{align*}
                \mu_W & = \sum_{w \in S_W} w P(W = w)                                                                                                                                                                                                                                                 \\
                      ...
                      & = \frac{1}{8} \left(\cos^2 \left(\frac{-3 \pi}{8}\right) + \cos^2 \left(\frac{-\pi}{4}\right) + \cos^2 \left(\frac{-\pi}{8}\right) + \cos^2 \left(\frac{\pi}{8}\right) + \cos^2 \left(\frac{\pi}{4}\right) + \cos^2 \left(\frac{3 \pi}{8}\right) + \cos^2 \left(\frac{\pi}{2}\right)\right) \\
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            \begin{center}
                \includegraphics[width=0.5\textwidth]{images/6a.png}
            \end{center}
