        ...
        \begin{solution}
            ...
            \begin{align*}
                \sigma_Y^2 & = \sum_{y \in S_Y} (y - \mu_Y)^2 P(Y = y)                                                                    \\
                           ...
                           & = \frac{1}{8} ((-2 (-3)^2 + 3 - \mu_Y)^2 + \dots + (-2 (4)^2 + 3 - \mu_Y)^2)                                                  \\
                           & = 105
            \end{align*}
        \end{solution}
        ...
        \begin{solution}
            ...
            \begin{align*}
                \mu_W & = \sum_{w \in S_W} w P(W = w)                                                                                                                                                                                      \\
                      ...
                      & = \frac{1}{8} \left(\cos^2 \left(\frac{\pi (-3)}{8}\right) + \dots + \cos^2 \left(\frac{\pi (4)}{8}\right)\right)                 \\
                      & = 0.5                                                                                                                                                                                          
            \end{align*}
            The variance of $W$ is given by
            \begin{align*}
                \sigma_W^2 & = \sum_{w \in S_W} (w - \mu_W)^2 P(W = w)                                                                                                                                                                      \\
                           & = \frac{1}{8} \sum_{x = -3}^4 (\cos^2 \left(\frac{\pi x}{8}\right) - \mu_W)^2                                                                                                                                    \\
                           & = \frac{1}{8} \left((\cos^2 \left(\frac{\pi (-3)}{8}\right) - \mu_W)^2 + \dots + (\cos^2 \left(\frac{\pi (4)}{8}\right) - \mu_W)^2\right)                                                                                                      \\
                           & = 0.125
            \end{align*}
        \end{solution}
    \end{parts}
